...
exports.getDashboardMatrices = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const getDashboardMatrices = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCategory = expenseByCategorySummaryRaw.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString(2) })));
        res.status(200).json({
            popularProducts,
            saleSummary,
            purchaseSummary,
...
exports.getDashboardMatrices = getDashboardMatrices;
